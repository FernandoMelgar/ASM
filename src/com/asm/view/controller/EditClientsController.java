...
public class EditClientsController {
    ...
    public GridPane generateAutomobileGridPanel(int state, AutomobileProperty ap) {
        ...
        brandInput.setText(ap.getBrand());
        modelInput.setText(ap.getModel());
        licencePalteInput.setText(ap.getLicencePlate());
        kilometersInput.setText(ap.getCurrentKm());
        yearInput.setText(ap.getYear());
        serialNumberInput.setText(ap.getSerialNumber());
    ...
    public void init(ScrollPane mainScrollPane, ClientProperty clientProperty) {
        this.mainScrollPane = mainScrollPane;
        this.clientProperty = clientProperty;
        this.newNameInput.setText(clientProperty.getFirstName());
        this.newEmailInput.setText(clientProperty.getFirstName());
        this.newSurnameInput.setText(clientProperty.getSurnames());
        this.newEmailInput.setText(clientProperty.getEmail());
        this.newAddressInput.setText(clientProperty.getAddress());
        this.newPhoneInput.setText(clientProperty.getPhoneNumber());
